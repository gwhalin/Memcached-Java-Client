...
public class UnitTests {
	...
	// logger
	private static Logger log = LoggerFactory.getLogger(UnitTests.class);
	...
	public static void test15() {
		...
		Map<String, Map<String, String>> stats = mc.statsItems();
		assert stats != null;
	...
	public static void main(String[] args) {
		...
		String[] serverlist = { "localhost:11111" };
	...
	public static final class TestClass implements Serializable {
		...
		private static final long serialVersionUID = -3038651029465723995L;
